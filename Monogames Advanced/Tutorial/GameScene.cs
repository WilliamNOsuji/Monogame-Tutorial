...
namespace Tutorial
{
    public class GameScene : IScene
    {
        ...
        public List<Rectangle> getIntersectTilesX(Rectangle target)
        {
            ...
            Debug.WriteLine("Size OV : " + target.Size);
            Debug.WriteLine("Width : " + target.Width);
            Debug.WriteLine("Height : " + target.Height);
            Debug.WriteLine("TitleSize : " + TILESIZE);
            Debug.WriteLine("Calculation Modulo : " + (target.Width % TILESIZE));
            Debug.WriteLine("Result : " + widthTiles);
